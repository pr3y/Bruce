...
#define VRC_VBANK(bank, value, high)                                                                         \
    {                                                                                                        \
        if ((high)) highnybbles[(bank)] = (value) & 0x0F;                                                    \
        else lownybbles[(bank)] = (value) & 0x0F;                                                            \
...
static void map21_write(uint32 address, uint8 value) {
    switch (address) {
        case 0x8000:
            if (select_c000) mmc_bankrom(8, 0xC000, value);
            else mmc_bankrom(8, 0x8000, value);
            break;
        ...
        case 0x9000:
            switch (value & 3) {
                ...
                case 2: ppu_mirror(0, 0, 0, 0); break;

                case 3: ppu_mirror(1, 1, 1, 1); break;
        ...
        case 0xF006:
        case 0xF003:
        case 0xF0C0: irq.enabled = irq.wait_state; break;
...
static void map22_write(uint32 address, uint8 value) {
    ...
    switch (reg) {
        case 0x8: mmc_bankrom(8, 0x8000, value); break;

        case 0xA: mmc_bankrom(8, 0xA000, value); break;
        ...
        case 0x9:
            switch (value & 3) {
                ...
                case 3: ppu_mirror(0, 0, 0, 0); break;
            }
            break;
...
static void map23_write(uint32 address, uint8 value) {
    switch (address) {
        case 0x8000:
        case 0x8FFF: mmc_bankrom(8, 0x8000, value); break;

        case 0xA000:
        case 0xAFFF: mmc_bankrom(8, 0xA000, value); break;
        ...
        case 0xF00C: irq.enabled = irq.wait_state; break;
