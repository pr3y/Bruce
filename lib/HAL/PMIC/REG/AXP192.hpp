...
enum pmic_pekey_poweroff_arg : uint8_t
{
    AXP192_POWEROFF_4S,
    AXP192_POWEROFF_65,
    AXP192_POWEROFF_8S,
...
enum pmic_pekey_long_press : uint8_t
{
...
enum pmic_backup_batt_vol : uint8_t
{
...
enum pmic_backup_batt_curr : uint8_t
{
