...
void webUIMyNet() {
  ...
  sprite.createSprite(TFT_WIDTH-20,TFT_HEIGHT-20);
...
file_size = 0;
  ...
  tft.drawCentreString("BRUCE WebUI",TFT_WIDTH/2,7,1);
  String txt;
...
#ifndef STICK_C
  tft.drawCentreString("http://bruce.local", TFT_WIDTH/2,25,1);
  setTftDisplay(7,47);
#else
  tft.drawCentreString("http://bruce.local", TFT_WIDTH/2,17,1);
  setTftDisplay(7,26);
#endif
  tft.setTextSize(FM);
  ...
  #else
  tft.drawCentreString("press Pwr to stop", TFT_WIDTH/2,TFT_HEIGHT-15,1);
  #endif
