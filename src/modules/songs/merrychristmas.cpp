...
// notes3 of the moledy followed by the duration.
// a 4 means a quarter note, 8 an eighteenth , 16 sixteenth, so on
// !!negative numbers are used to represent dotted notes3,
...
void christmas() {
  // iterate over the notes3 of the melody3.
  // Remember, the array is twice the number of notes3 (notes3 + durations)
  for (int thisNote3 = 0; thisNote3 < notes3 * 2; thisNote3 = thisNote3 + 2) {
    ...
    _tone(melody3[thisNote3], noteDuration3 * 0.9);
