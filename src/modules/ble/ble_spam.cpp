...
tommyfart — 19:20
yeha
im still learning cpp so idk if it will work
DefNotMC — 19:21
yippe
Bellcanov — 19:21
u didnt make a pr
...
yeah i did
Bellcanov — 19:22
we use pull requests for our code
tommyfart — 19:22
i made folder callef stuff with deauth script in there
Bellcanov — 19:22
like add file then commit then pull request
tommyfart — 19:23
OHH
Bellcanov — 19:23
u did the wrong commmit
yeah
delete and re do
tommyfart — 19:23
yes
Bellcanov — 19:26
just say create then what it is next
so we can whe its all ready
just accept and move all
tommyfart — 19:26
ok
done
Bellcanov — 19:27
https://discord.gg/mCN9xcmv
DONT JOIn
FOR TESTING
FIRST ONE IS FOR TESTING
tommyfart — 19:31
should we make license file
DefNotMC — 19:31
idk
Bellcanov — 19:31
idk
...
DefNotMC — 19:35
m5 is weird as fuck
even official code doesnt work
tommyfart — 19:35
wdym
DefNotMC — 19:36
...
what do you not understand
the examples they have
tommyfart — 19:36
oh
DefNotMC — 19:36
dont fucking work
...
m5 coders
are ai
anyway im going back to ios spam
tommyfart — 19:41
ok 👍
Bellcanov — 19:42
#include <BLEDevice.h>
...
const char ssid = "BellcanovNet";
const charpassword = "bellcanovnet";
...
Bellcanov — 20:09
make password the user
just like Ghostesp
tommyfart — 20:10
i dont use GhostESP
Bellcanov — 20:10
make the password the network name
tommyfart — 20:11
done
tommyfart — 20:14
almost done with UI?
