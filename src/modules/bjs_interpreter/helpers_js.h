...
void bduk_register_c_lightfunc(duk_context *ctx, const char *name, duk_c_function func, duk_idx_t nargs, duk_idx_t magic = 0);
...
void bduk_put_prop_c_lightfunc(duk_context *ctx, duk_idx_t obj_idx, const char *name, duk_c_function func, duk_idx_t nargs, duk_idx_t magic=0);
